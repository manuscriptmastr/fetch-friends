...
var apply =
/*#__PURE__*/
_curry2_1(function apply(fn, args) {
...
var mergeDeepLeft =
/*#__PURE__*/
_curry2_1(function mergeDeepLeft(lObj, rObj) {
...
const basicAuthHeader = curry_1((username, password) =>
  ({ 'Authorization': `Basic ${Buffer.from(`${username}:${password}`).toString('base64')}`}));
const bearerAuthHeader = (token) =>
  ({ 'Authorization' : `Bearer ${token}` });

// fetch decorators
const options = curry_1((decorate, fetch) => pipe_1(async (url, opts = {}) => [url, mergeDeepLeft_1(opts, is_1(Function, decorate) ? await decorate(opts) : decorate)], andThen_1(apply_1(fetch))));
const option = curry_1((key, value, fetch) => options(async () => ({ [key]: is_1(Function, value) ? await value() : value }), fetch));
const method = option('method');
const headers = option('headers');
const timeout = curry_1((ms, fetch) => option('signal', () => abort(ms), fetch));
const body = fetch => (json, url, opts = {}) => options({
  method: 'POST',
...
const decorate = curry_1((fetch, decorators) => compose_1(...decorators)(fetch));

exports.abort = abort;
exports.andThen = andThen_1;
exports.basicAuthHeader = basicAuthHeader;
exports.bearerAuthHeader = bearerAuthHeader;
exports.body = body;
exports.compose = compose_1;
...
exports.pipe = pipe_1;
exports.rejectIfNotOkay = rejectIfNotOkay;
